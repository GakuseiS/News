        ...
        <footer className='footer'>
            <nav className='footer__nav'>
                <ul className='footer__list'>
                    <li className='footer__item'><Link to={'/'} className='footer__link'>Лента</Link></li>
                    ...
                    <li className='footer__item'><Link to={'/about'} className='footer__link'>О проекте</Link></li>
